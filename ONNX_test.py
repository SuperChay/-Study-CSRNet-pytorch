...
# img = transform(Image.open(r"C:\Users\36432\Desktop\test3.jpg").convert('RGB')).cuda()
img = transform(Image.open(r'D:\re2\test_model\test_image\images\IMG_test.jpg').convert('RGB'))
'''
